...
Processing = namedtuple("Processing", "input_shape prep_steps conf_thres iou_thres")
...
def get_configs():
    ...
    parser.add_argument("-i", "--image", type=str, help="Image source")
    ...
    if metadata:
        if not opt.conf_thres:
            opt.conf_thres = metadata.conf_thres
