...
@onnx_infer_func.register("yolov6s_infer")
def yolov6s_infer(executor):
    ROOT = os.path.dirname(executor.dataset)
    weights=executor
    source=executor.dataset # osp.join(ROOT, 'data/images'),
    webcam=False
    webcam_addr=0
